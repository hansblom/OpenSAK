...
STRINGS: dict[str, str] = {
    ...
    "import_again":                 "Import på nytt",
    "import_select_file_label":     "Välj en GPX fil eller Pocket Query ZIP file:",
    "import_no_file":               "Ingen fil vald",
    "import_browse_title":          "Välj GPX or ZIP fil",
    "import_file_filter":           "GPX och ZIP filer (*.gpx *.zip);;Alla filer (*)",
    "import_running_file":          "Importerar {name}…",
    "import_progress":              "Behandlar cacher: {count}…",
    "import_saving":               "Sparar till databasen…",
    "import_table_loaded":         "✓ {count} cacher laddade — klicka på en cache för att visa på kartan",
    ...
    "gps_confirm_delete_msg":       "<b>{count} GPX fil(er)</b> kommer att tas bort från GPS enheten före uppladdning.\n\nÄr du säker?",
    ...
    # ── Found dialog ──────────────────────────────────────────────────────────
    "found_ref_group":              "Referensdatabas (Mina Hittade)",
